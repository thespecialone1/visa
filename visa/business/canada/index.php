    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <h2 class="page-title   text-shadow-black"> Business Visa to Canada</h2>
    ...
    <div class="row ">
        ...
        <div class="col-12 col-md-8">
            <ul class="list-group list-group-flush check-circle listnone" style="margin-bottom: 0; ">
                <li class="list-group-item" style="padding:0 1.5rem"> Expand your business</li>
                <li class="list-group-item" style="padding:0 1.5rem"> Start a new business</li>
                <li class="list-group-item" style="padding:0 1.5rem"> Attend trade shows</li>
                <li class="list-group-item" style="padding:0 1.5rem"> Attend trade shows</li>
                <li class="list-group-item" style="padding:0 1.5rem"> Apply for <a href="/visa/pr/canada/" class="text-primary">Canada PR</a></li>
            </ul>
        </div>
    ...
    <div class="row  justify-content-md-center">
        ...
        <div class="col-12 col-md-8 mt-5">
            <ul class="list-group list-group-flush check-circle listnone" style="margin-bottom: 0; ">
                ...
                <li>Stay for up to 6 months in Canada.</li>
            </ul>
        </div>
        ...
        <div class="col-12 col-md-8 mt-5">
            <ul class="list-group list-group-flush check-circle listnone" style="margin-bottom: 0; ">
                ...
                <li>You must have close links to your home country in order to return after your stay.</li>
                <li>You must be of good character and have a clear criminal record. For this, you may be required to have a PCC (Police Clearance Certificate).</li>
                <li>You must at least meet the authorities’ minimum health standards.</li>
                <li>You must have a valid invitation from a legitimate company in the country where you are/will be doing business.</li>
            </ul>
        </div>
        ...
        <div class="col-12 col-md-8 mt-5">
            <ul class="list-group list-group-flush check-circle listnone" style="margin-bottom: 0; ">
                ...
                <li>Have the required proficiency in English or French</li>
                <li>Have completed at least 1 year of post-secondary education</li>
                <li>Have enough funds to settle in Canada and to support dependent family members</li>
                <li>Clearing the medical tests and security requirements</li>
            </ul>
        </div>
                    ...
                    <div class="card-accordion-header" id="headingOne">
                        <h5 class="mb-0">
                            <button class="accordion-btn" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                How long can I stay in Canada on a Business Permit?
                            </button>
                        </h5>
                    </div>
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion" style="">
                        <div class="card-accordion-body">
                            <p>The Canada Business Permit is a provisional. It has a maximum validity of 6 months. It’s advisable that you stay for the period that you have specified in the application, even if it’s less than 6 months. The Embassy can offer you a permit that has longer validity such as 3, 5, or 10 years. However, you must not remain for more than 6 months at a time.</p>
                        </div>
                    </div>
                </div>
                <div class="card-accordion">
                    <div class="card-accordion-header" id="headingTwo">
                        <h5 class="mb0">
                            <button class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                How do I get a Canadian Business Permit?
                            </button>
                        </h5>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style="">
                        <div class="card-accordion-body">
                            <p>The 5 stages given below are common in any application for Canada Business Permit irrespective of the business immigration stream you choose to apply:</p>
                            <h2 class="text-primary">Check your eligibility</h2>
                            <p>
                            ...
                            <p>
                                ...
                                You must select the category that’s most suitable for the business type that you want to expand overseas in Canada.
                            </p>
                            <h2 class="text-primary">
                                Collate the required paperwork
                            </h2>
                            <p>
                                This is undoubtedly the most tiresome part of the process of business immigration to Canada. You must have all the records of information that will be a poof of fulfilling the requirements of the chosen business stream.
                            ...
                            <h2 class="text-primary">
                                Obtain a Permit or an ETA
                            </h2>

                            <p>

                                You will have to get ready for your trip to Canada once your application is successful. You can obtain the Permit or the ETA (Electronic Travel Authorization).
                            </p>
                    ...
                    <div class="card-accordion-header" id="headingThree">
                        <h5 class="mb-0">
                            <button class="collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                How long does it take to get a Canada Business Permit?
                            </button>
                        </h5>
                    </div>
