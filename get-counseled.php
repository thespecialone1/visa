...
<section class="container mt-3">
    <div class="row ">
        <div class="col-12 col-md-4">
            ...
            <p>Fill the following form with your Query and our Experts will contact you ASAP.</p>
        </div>
        <div class="col-12 col-md-8">
            <form class="needs-validation" novalidate action="/php/action.php" method="post">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="contact" class="form-control" id="phone" placeholder="" required>
                ...
                <button class="btn btn-primary  btn-block mb-5" type="submit">Get Started</button>
            </form>
        </div>
